...
let filtroID = data.events.find((e) => e._id === id);
//console.log(filtroID);

let contenedor = document.getElementById("contenedorN");
//for (let i = 0; i < filtroID.length; i++) {
...
tarjeta.innerHTML = `
                            <div class="caja">
                                ...
                                <div class="col-12 col-md-6 bg-white rounded-3 p-5">
                                    ...
                                    <p>Capacity: ${filtroID.capacity}</p>
                                    <p>Estimate: ${filtroID.estimate}</p>
                                    <p>Price: ${filtroID.price}</p>
                                </div>
                            </div>    
